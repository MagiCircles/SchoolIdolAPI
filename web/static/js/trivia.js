...
Elm.Main.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var formatComment = function (score) {
      return _U.cmp(score,0) < 1 ? "Ouch!" : _U.cmp(score,3) < 1 ? "Oh no..." : _U.cmp(score,5) < 1 ? "Meh." : _U.cmp(score,7) < 1 ? "Not bad!" : _U.cmp(score,
      8) < 1 ? "Yay~" : _U.eq(score,9) ? "Awesome!" : "Woohoo!";
   };
   var formatProgress = function (l) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("progress")]),
      A2($List.map,
      function (b) {
         return A2($Html.div,_U.list([$Html$Attributes.$class(A2($Basics._op["++"],"progress-bar progress-bar-",b ? "success" : "danger"))]),_U.list([]));
      },
      $List.reverse(l)));
   };
   var mapQuestion = F3(function (ctor,element,l) {
      ...
      if (_p0.ctor === "Nothing") {
            ...
            return A2($List._op["::"],ctor(_p0._0),l);
         }
   });
   _op["**"] = F2(function (func,value) {    return A3($Json$Decode.object2,F2(function (x,y) {    return x(y);}),func,value);});
   var Model = F4(function (a,b,c,d) {    return {idols: a,question: b,seed: c,score: d};});
   var Answer = F2(function (a,b) {    return {ctor: "Answer",_0: a,_1: b};});
   var idolOptions = F4(function (address,question,idol,idols) {
      var format = function (element) {
         return A2($Html.figure,
         _U.list([$Html$Attributes.$class("trivia_idol")]),
         _U.list([A2($Html.img,
                 _U.list([$Html$Attributes.src(element.chibi),A2($Html$Events.onClick,address,A2(Answer,question,element))]),
      ...
      var aux = F2(function (acc,l) {
         aux: while (true) {
            ...
            if (_p1.ctor === "[]") {
                  ...
                  var _v2 = A2($List._op["::"],format(_p1._0),acc),_v3 = _p1._1;
                  acc = _v2;
                  l = _v3;
                  continue aux;
               }
   ...
   var resultView = F2(function (addr,model) {
      var score = A3($List.foldl,F2(function (answer,s) {    return answer ? s + 1 : s;}),0,model.score);
      var fprogress = formatProgress(model.score);
      var comment = formatComment(score);
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("final_result")]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("row")]),
              _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("col-md-6")]),
                      _U.list([A2($Html.h3,_U.list([]),_U.list([$Html.text("Final Score")]))
                              ,A2($Html.span,_U.list([$Html$Attributes.$class("final_score")]),_U.list([$Html.text($Basics.toString(score))]))]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("col-md-6")]),
                      _U.list([A2($Html.p,_U.list([$Html$Attributes.$class("score_comment")]),_U.list([$Html.text(comment)]))
                              ,A2($Html.p,
                              ...
                              _U.list([A2($Html.a,
                                      _U.list([$Html$Attributes.href(A2($Basics._op["++"],
                                              ...
                                              A2($Basics._op["++"],
                                              "/10 on School Idol Trivia! ",
                                              A2($Basics._op["++"],
                                              comment,
                                              " Play with me:&via=schoolidolu&url=http://schoolido.lu/trivia/&hashtags=LLSIF,LoveLive,スクフェス")))))
                                              ,$Html$Attributes.target("_blank")
                                              ,$Html$Attributes.$class("btn btn-Cool")]),
                                      _U.list([A2($Html.img,_U.list([$Html$Attributes.src("/static/twitter.png")]),_U.list([]))
                                              ,$Html.text(" Tweet your score")]))
                                      ,A2($Html.br,_U.list([]),_U.list([]))
                                      ,A2($Html.br,_U.list([]),_U.list([]))
                                      ,A2($Html.form,
                                      _U.list([$Html$Attributes.method("POST"),$Html$Attributes.action("/ajax/trivia/share/")]),
                                      _U.list([A2($Html.input,
                                              _U.list([$Html$Attributes.type$("hidden")
                                                      ,$Html$Attributes.name("score")
                                                      ,$Html$Attributes.value($Basics.toString(score))]),
                                              _U.list([]))
                                              ,A2($Html.input,
                                              _U.list([$Html$Attributes.type$("submit")
                                                      ,$Html$Attributes.value("Share on School Idol Tomodachi")
                                                      ,$Html$Attributes.$class("btn btn-link")]),
                                              _U.list([]))]))
                                      ,A2($Html.br,_U.list([]),_U.list([]))
                                      ,A2($Html.br,_U.list([]),_U.list([]))
                                      ,A2($Html.a,
                                      _U.list([A2($Html$Events.onClick,addr,Restart),$Html$Attributes.href("#")]),
                                      _U.list([$Html.text("Try again")]))
                                      ,A2($Html.br,_U.list([]),_U.list([]))
                                      ,A2($Html.br,_U.list([]),_U.list([]))]))]))]))
              ,fprogress]));
   });
   ...
   var End = {ctor: "End"};
   var Pending = F3(function (a,b,c) {    return {ctor: "Pending",_0: a,_1: b,_2: c};});
   var Hobby = function (a) {    return {ctor: "Hobby",_0: a};};
   var LeastFood = function (a) {    return {ctor: "LeastFood",_0: a};};
   ...
   var idolDecoder = function () {
      ...
      A2(_op["**"],
      A2(_op["**"],
      A2($Json$Decode.map,Idol,A2($Json$Decode._op[":="],"name",$Json$Decode.string)),
      A2($Json$Decode._op[":="],"japanese_name",$Json$Decode.string)),
      A2($Json$Decode._op[":="],"chibi_small",$Json$Decode.string)),
      A2($Json$Decode._op[":="],"attribute",$Json$Decode.string)),
      A2($Json$Decode._op[":="],"birthday",$Json$Decode.string)),
      A2($Json$Decode._op[":="],"height",$Json$Decode.$int)),
      $Json$Decode.maybe(A2($Json$Decode._op[":="],"favorite_food",$Json$Decode.string))),
      $Json$Decode.maybe(A2($Json$Decode._op[":="],"least_favorite_food",$Json$Decode.string))),
      $Json$Decode.maybe(A2($Json$Decode._op[":="],"hobbies",$Json$Decode.string)));
      return A2($Json$Decode._op[":="],"results",$Json$Decode.list(idol));
   }();
   var url = "http://schoolido.lu/api/idols/?ordering=random&cards__is_special=False&page_size=100";
   var getIdols = function (_p2) {    return $Effects.task(A2($Task.map,GotIdols,$Task.toMaybe(A2($Http.get,idolDecoder,url))));};
   var nth = F2(function (n,l) {
      nth: while (true) {
         var _p3 = l;
         if (_p3.ctor === "[]") {
               return $Maybe.Nothing;
            } else {
               if (_U.cmp(n,0) < 1) return $Maybe.Just(_p3._0); else {
                     var _v5 = n - 1,_v6 = _p3._1;
                     n = _v5;
                     l = _v6;
                     continue nth;
                  }
   ...
   var randomInt = F2(function (upper,seed) {    return A2($Random.generate,A2($Random.$int,0,upper),seed);});
   var takeRandom = F2(function (l,seed) {
      var len = $List.length(l) - 1;
      var _p4 = A2(randomInt,len,seed);
      var qid = _p4._0;
      var s = _p4._1;
      var _p5 = A2(nth,qid,l);
      if (_p5.ctor === "Just") {
            return $Maybe.Just({ctor: "_Tuple2",_0: _p5._0,_1: s});
         } else {
            return $Maybe.Nothing;
         }
   });
   var randomChoices = F4(function (idol,num,idols,seed) {
      var aux = F4(function (idolss,n,acc,seed) {
         aux: while (true) if (_U.eq(n,0)) return {ctor: "_Tuple2",_0: acc,_1: seed}; else {
               var _p6 = A2(takeRandom,idolss,seed);
               if (_p6.ctor === "Nothing") {
                     return {ctor: "_Tuple2",_0: acc,_1: seed};
                  } else {
                     var _p7 = _p6._0._0;
                     var _v9 = A2($List.filter,F2(function (x,y) {    return !_U.eq(x,y);})(_p7),idolss),
                     _v10 = n - 1,
                     _v11 = A2($List._op["::"],_p7,acc),
                     _v12 = _p6._0._1;
                     idolss = _v9;
                     n = _v10;
                     acc = _v11;
      ...
      return A4(aux,A2($List.filter,F2(function (x,y) {    return !_U.eq(x,y);})(idol),idols),num,_U.list([idol]),seed);
   });
   var shuffleList = F2(function (idols,seed) {
      var len = $List.length(idols);
      var _p8 = idols;
      if (_p8.ctor === "[]") {
            return {ctor: "_Tuple2",_0: idols,_1: seed};
         } else {
            if (_p8._1.ctor === "[]") {
                  return {ctor: "_Tuple2",_0: idols,_1: seed};
               } else {
                  return A4(randomChoices,_p8._0,len - 1,idols,seed);
               }
         }
   });
   var pickIdol = function (l) {    return takeRandom(l);};
   var pickQuestion = F2(function (idols,seed) {
      var _p9 = idols;
      if (_p9.ctor === "Just") {
            var _p16 = _p9._0;
            var _p10 = A2(pickIdol,_p16,seed);
            if (_p10.ctor === "Just") {
                  var _p15 = _p10._0._1;
                  var _p14 = _p10._0._0;
                  ...
                  Hobby,
                  _p14.hobbies,
                  A3(mapQuestion,LeastFood,_p14.least_favorite_food,A3(mapQuestion,Food,_p14.favorite_food,_U.list([]))));
                  var _p11 = A2(takeRandom,questions,_p15);
                  if (_p11.ctor === "Just") {
                        var _p12 = A4(randomChoices,_p14,5,_p16,_p11._0._1);
                        var choices = _p12._0;
                        var seed = _p12._1;
                        var _p13 = A2(shuffleList,choices,seed);
                        var shuffled = _p13._0;
                        var seed = _p13._1;
                        return {ctor: "_Tuple2",_0: A3(Pending,_p14,shuffled,_p11._0._0),_1: seed};
                     } else {
                        return {ctor: "_Tuple2",_0: Debug("Error while choosing a question"),_1: _p15};
                     }
               } else {
                  return {ctor: "_Tuple2",_0: Debug("Error while picking an idol for this question"),_1: seed};
               }
         } else {
            return {ctor: "_Tuple2",_0: Debug("Error while fetching idols"),_1: seed};
         }
   });
   var update = F2(function (action,model) {
      var _p17 = action;
      switch (_p17.ctor)
      {case "Restart": var _p18 = A2(pickQuestion,model.idols,model.seed);
           var question = _p18._0;
           var seed = _p18._1;
           return {ctor: "_Tuple2",_0: {question: question,seed: seed,score: _U.list([]),idols: model.idols},_1: $Effects.none};
         case "Answer": var _p19 = model.question;
           if (_p19.ctor === "Pending") {
                 var score = !_U.eq(_p19._0.name,_p17._1.name) ? false : true;
                 var _p20 = !_U.eq($List.length(model.score),9) ? A2(pickQuestion,model.idols,model.seed) : {ctor: "_Tuple2",_0: End,_1: model.seed};
                 var question = _p20._0;
                 var seed = _p20._1;
                 return {ctor: "_Tuple2",_0: _U.update(model,{question: question,seed: seed,score: A2($List._op["::"],score,model.score)}),_1: $Effects.none};
              } else {
                 return {ctor: "_Tuple2",_0: _U.update(model,{question: Debug("Error")}),_1: $Effects.none};
              }
         default: var _p22 = _p17._0;
           var _p21 = A2(pickQuestion,_p22,model.seed);
           var question = _p21._0;
           var seed = _p21._1;
           return {ctor: "_Tuple2",_0: _U.update(model,{question: question,seed: seed,idols: _p22}),_1: $Effects.none};}
   });
   ...
   var formatQuestion = function (q) {
      var s = function () {
         var _p23 = q;
         switch (_p23.ctor)
         {case "Hobby": return A2($Basics._op["++"],"Who likes ",A2($Basics._op["++"],$String.toLower(_p23._0),"?"));
            case "Food": return A2($Basics._op["++"],"Who likes ",A2($Basics._op["++"],$String.toLower(_p23._0),"?"));
            default: return A2($Basics._op["++"],"Who dislikes ",A2($Basics._op["++"],$String.toLower(_p23._0),"?"));}
      }();
      return A2($Html.div,_U.list([$Html$Attributes.$class(A2($Basics._op["++"],"question text-",btnColor))]),_U.list([$Html.text(s)]));
   };
   var view = F2(function (address,model) {
      var str = function () {
         var _p24 = model.question;
         switch (_p24.ctor)
         {case "Debug": return $Html.text(_p24._0);
            case "End": return A2(resultView,address,model);
            case "Pending": var _p26 = _p24._2;
              var fquestion = formatQuestion(_p26);
              var fprogress = formatProgress(model.score);
              var _p25 = model.idols;
              if (_p25.ctor === "Just") {
                    return A2($Html.div,
                    _U.list([]),
                    A2($Basics._op["++"],_U.list([fquestion]),A2($Basics._op["++"],A4(idolOptions,address,_p26,_p24._0,_p24._1),_U.list([fprogress]))));
                 } else {
                    return $Html.text("Weird");
                 }
            default: return A2($Html.i,_U.list([$Html$Attributes.$class("flaticon-loading")]),_U.list([]));}
      }();
      return A2($Html.div,_U.list([$Html$Attributes.$class("sit")]),_U.list([A2($Html.strong,_U.list([]),_U.list([str]))]));
   });
   ...
   var init = {ctor: "_Tuple2",_0: {score: _U.list([]),question: Init,idols: $Maybe.Nothing,seed: initialSeed},_1: getIdols({ctor: "_Tuple0"})};
