...
urlpatterns = patterns('',
    ...
    url(r'^activitiesids/(?P<ids>[0-9,]+)[/]+$', views.activities_ids, name='activity'),
    ...
    url(r'^staff/giveaway_generator[/]$', views.staff_giveaway_generator, name='staff_giveaway_generator'),
    ...
    url(r'^ajax/messages[/]+$', views.messages, { 'ajax': True }, name='messages'),
    ...
    url(r'^ajax/staff/report/(?P<report_id>\d+)/accept_and_delete/$', views.ajaxreport, {'status': 'accept_and_delete'}, name='ajaxreport'),
